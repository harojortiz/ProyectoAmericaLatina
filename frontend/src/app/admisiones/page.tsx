                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1577891742442-5f6312a0257e?q=80&w=2000&auto=format&fit=crop" className="w-full h-64 object-cover border-4 border-white shadow-xl" alt="Estudiante" />
                            <img src="https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=2000&auto=format&fit=crop" className="w-full h-64 object-cover border-4 border-white shadow-xl mt-8" alt="Docente" />
                        </div>
                    </div>
                </div>
            </section>
